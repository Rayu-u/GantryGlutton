...
(function (GantryGlutton) {
    ...
    class Trapdoor extends f.ComponentScript {
        ...
        onAfterPhysicsUpdate = () => {
            const rotation = this.#rigidbody.getRotation();
        ...
        open = async (openAngularImpulse, closeTorque, duration) => {
            ...
            this.#rigidbody.applyAngularImpulse(new f.Vector3(openAngularImpulse, 0, 0));
